      ...
      <div class="tile-body">
        <ul class="nav nav-pills flex-column mail-nav">
          <li class="nav-item active">
            ...
            <a class="btn btn-primary icon-btn btn-sm float-right"
              onclick="cargar_contenido('Contenido_principal','../view/personal/view_crear_editar_persona.php')"><i
                class="fa fa-plus-circle " aria-hidden="true" style="color: white;"></i>&nbsp;<strong
                style="color: white;">Nuevo Registro</strong></a>
  ...
  <div class="col-md-12">
    <div class="tile" style="border-top: 3px solid #0720b7;border-radius: 5px;">
      ...
      <div class="row invoice-info">
        ...
        <div class="col-sm-4">
          <h5 class=""><strong>Gestión de Personas -
              <?php echo date("Y"); ?>
            </strong></h5>
        </div>
        <div class="col-sm-4">
          <div class="input-group">
            <input type="text" class="global_filter form-control" id="global_filter"
              placeholder="Ingresar dato a buscar" style="border-radius: 5px;">
